...
import java.net.URL;
public class CPR5ContraseaDebilTest {
  ...
  @Test
  public void cPR5ContraseaDebil() {
    ...
    assertThat(driver.switchTo().alert().getText(), is("La contraseña debe tener al menos 8 caracteres"));
  }
}
