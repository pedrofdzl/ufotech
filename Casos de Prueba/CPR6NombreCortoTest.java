...
import java.net.URL;
public class CPR6NombreCortoTest {
  ...
  public void cPR6NombreCorto() {
    ...
    driver.findElement(By.id("nameField")).sendKeys("J");
    ...
    assertThat(driver.switchTo().alert().getText(), is("El nombre debe tener al menos 3 caracteres"));
  }
}
